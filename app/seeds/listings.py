...
def seed_listings():
    ...
    test2 = Listing(userId = 2,description='built this from scratch all switches are lubed',price=250,condition='Minimal Wear',category='Keyboard',subcategory='Full-Size',image='https://thegadgetflow.com/wp-content/uploads/2021/05/Top-5-mechanical-keyboards-for-your-workspace-blog-featured.jpeg')
