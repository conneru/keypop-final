...
def seed_listings():
    ...
    test2 = Listing(userId = 1, purchaserId = 3,description='yes sir',price=10,condition='Factory New',category='Keyboard',image='https://thegadgetflow.com/wp-content/uploads/2021/05/Top-5-mechanical-keyboards-for-your-workspace-blog-featured.jpeg')
    test3 = Listing(userId = 1, purchaserId = 3,description='yes sir',price=10,condition='Factory New',category='Keyboard',image='https://hips.hearstapps.com/amv-prod-gp.s3.amazonaws.com/gearpatrol/wp-content/uploads/2019/11/Mechanical-Keyboard-Buying-Guide-Gear-Patrol-Feature.jpg')
    ...
    test5 = Listing(userId = 1, purchaserId = 3,description='yes sir',price=10,condition='Factory New',category='Keyboard',image='https://m.media-amazon.com/images/I/61N4RhDqCrL._AC_SY450_.jpg')
    test6 = Listing(userId = 1, purchaserId = 3,description='yes sir',price=10,condition='Factory New',category='Keyboard',image='https://cdn.shopify.com/s/files/1/0059/0630/1017/products/Keychron-K2-hot-swappable-wireless-mechanical-keyboard-for-Mac-Windows-iOS-Gateron-switch-blue-with-type-C-RGB-white-backlight_1800x1800.jpg?v=1604558657')
